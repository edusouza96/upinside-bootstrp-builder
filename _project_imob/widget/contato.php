<div class="main_contact py-5 bg-light text-center">
    <div class="container">
        ...
        <p class="mb-0">Quer conversar com um corretor exclusivo e ter o atendimento diferenciado em busca do seu imovel dos sonhos?</p>
        <p>oreenche  o formulario abaixo e vamos lhe direcionar para alguém que entende a sua necessidade!</p>
...
<div class="main_contract_types py-5">
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-12 col-md-4">
                ...
                <p>Estamos disponiveis no numero abaixo no horario comercial.</p>
