        ...
        <div class="row">
            <form action="" class="form-inline w-100">
                ...
                <div class="form-group col-3">
                    <label for="search"><b>Comprar ou Alugar?</b></label>
...
<section class="main_properties py-5">
    <div class="container">
        <div class="border-bottom d-flex justify-content-between align-items border-front mb-5">
        ...
        <div class="row">
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/1/089dac35-8d59-4cb0-bf0a-7b9a7d8642f1.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/2/7949553b-6a91-4acf-a2a2-0b9560b2eff3.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/3/48af3f47-4fdc-461c-ba7b-39eb759aba71.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
        ...
        <div class="row">
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/4/3b9d6713-3e86-4d41-a21b-6b77fc414bf3.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/5/0ed8b84d-67c1-4688-86de-433ec3a498d5.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/2/e65a8436-fd1c-4db7-bf50-ece54a58b6a7.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
